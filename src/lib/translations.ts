...
const en = {
  ...
  workWithUs: {
    eyebrow: "Careers & Contractors",
    heading: "Work With",
    headingItalic: "Andy’K Group",
    subtitle: "We collaborate with highly structured, self-directed independent contractors — operational partners who take ownership of their work.",
    openPositionsHeading: "Open Positions",
    contractorBadge: "Independent Contractor",
    remoteBadge: "Remote",
    viewRole: "View Role",
    noOpenings: "No additional openings at this time. Check back soon.",
    role: {
      title: "Personal Assistant & Sales Support",
      eyebrow: "Open Position — Independent Contractor",
      overviewLabel: "Role Overview",
      overview: "A remote independent contractor position supporting the operational and commercial layer of Andy’K Group International LTD. You will work closely with the founding team — handling administrative coordination, research tasks, and sales support activities.",
      typeLabel: "Contract Type",
      type: "Independent Contractor",
      locationLabel: "Location",
      location: "Remote — EU/UK time zones preferred",
      rateLabel: "Rate",
      rate: "Negotiable — per contractor agreement",
      aboutHeading: "About the Role",
      aboutBody: "This is not a conventional employment role. We work with independent contractors who bring structure, precision, and self-direction to every task. You will support the operational and commercial infrastructure of Andy’K Group — from administrative coordination to research and sales support — working directly with the founding team.",
      responsibilitiesHeading: "Responsibilities",
      responsibilities: [
        "Administrative coordination: scheduling, document management, follow-ups",
        "Research: market intelligence, prospect research, competitor analysis",
        "Sales support: CRM updates, outreach preparation, proposal formatting",
        "Client coordination: onboarding communications, documentation handling",
        "Operational admin: internal process support, data entry, structured reporting",
      ],
      requirementsHeading: "Requirements",
      requirements: [
        "Proven experience in admin, research, or sales support roles",
        "Strong written English — all internal communication is in English",
        "Self-directed with high attention to detail and structured thinking",
        "Comfortable working remotely and asynchronously",
        "Available for structured weekly check-ins (EU/UK time zones preferred)",
        "Proficient in CRM tools, Google Workspace, or equivalent platforms",
        "Active LinkedIn profile required",
      ],
      offerHeading: "What We Offer",
      offer: [
        "Competitive hourly rate — negotiated per contractor",
        "Remote-first, async-first working environment",
        "Direct collaboration with founders",
        "Structured contractor onboarding process",
        "Exposure to international B2B and B2G client engagements",
      ],
      applyHeading: "Apply for This Position",
      applyIntro: "Complete the application form below. We review all applications internally and respond within 5 business days.",
      compensationHeading: "Compensation",
      compensationText: "This is a part-time freelance contractor role. Expected workload: 10–20 hours per month. Monthly budget: up to €400, depending on experience, availability and agreed scope. Hourly rate to be agreed individually.",
      compensationCurrencyNote: "The currency selector is only for display/conversion purposes. The final contract currency will be agreed individually in the Contractor Agreement.",
      workModelLabel: "Work Model",
      workModelValue: "Hybrid preferred — remote possible by agreement",
      inPersonNote: "Ideal candidate should be available for occasional in-person working sessions in Vienna (typically 2–3 times per month), in addition to remote work, where useful for coordination and planning.",
      currencyEUR: "EUR (€)",
      currencyGBP: "GBP (£)",
      currencyUSD: "USD ($)",
    },
    form: {
      ...
      subheading: "Personal Assistant & Sales Support — Independent Contractor",
      required: "*",
      fullName: "Full Name",
      email: "Email Address",
      phone: "Phone Number",
      ...
      hourlyRate: "Preferred Hourly Rate",
      cvUpload: "Upload CV / Resume",
      cvHelper: "PDF, DOC or DOCX — max 10 MB",
      message: "Short Message",
      submit: "Submit Application",
      submitting: "Submitting…",
      successHeading: "Application Received",
      successText: "Thank you for applying. Our team reviews all applications internally and will respond within 5 business days.",
      privacy: "By submitting this form, you agree to our Privacy Policy. Your data is used solely for recruitment purposes.",
      phFullName: "Your full name",
      phEmail: "your@email.com",
      phPhone: "+44 000 000 0000",
      phLocation: "City, Country",
      phLanguages: "e.g. English, German, Dutch",
      phLinkedin: "linkedin.com/in/yourprofile",
      phAvailability: "e.g. 20 hrs/week from July 2026",
      phHourlyRate: "e.g. €25/hr",
      phMessage: "Tell us why you’re a good fit for this role…",
    },
    onboarding: {
      eyebrow: "Contractor Onboarding",
      heading: "Getting Started as a",
      headingItalic: "Contractor",
      subtitle: "A structured onboarding process for new Andy’K Group independent contractors.",
      steps: [
        { title: "Application Submitted", description: "Your application is received and reviewed internally by the operations team." },
        { title: "Screening Call", description: "A 20–30 minute video call to assess fit, discuss the role, and answer your questions." },
        { title: "Trial Task", description: "A short, paid trial task to evaluate working style and output quality." },
        { title: "Contract & Agreement", description: "Review and sign the Independent Contractor Agreement. All contracts are digital." },
        { title: "System Onboarding", description: "Access credentials, tool orientation, and first structured briefing with the team." },
        { title: "Active Engagement", description: "Your first structured task is assigned. Weekly check-ins begin." },
      ],
      nextStepsHeading: "Questions?",
      nextStepsBody: "Contact the operations team at info@andykgroup.com for any onboarding queries.",
    },
    documents: {
      eyebrow: "Contractor Resources",
      heading: "Document",
      headingItalic: "Centre",
      subtitle: "Official contractor documents — agreements, policies, and operational references.",
...
const es: typeof en = {
  ...
  workWithUs: {
    eyebrow: "__TODO_TRANSLATE__",
    heading: "__TODO_TRANSLATE__",
    headingItalic: "__TODO_TRANSLATE__",
    subtitle: "__TODO_TRANSLATE__",
    openPositionsHeading: "__TODO_TRANSLATE__",
    contractorBadge: "__TODO_TRANSLATE__",
    remoteBadge: "__TODO_TRANSLATE__",
    viewRole: "__TODO_TRANSLATE__",
    noOpenings: "__TODO_TRANSLATE__",
    role: {
      title: "__TODO_TRANSLATE__",
      eyebrow: "__TODO_TRANSLATE__",
      overviewLabel: "__TODO_TRANSLATE__",
      overview: "__TODO_TRANSLATE__",
      typeLabel: "__TODO_TRANSLATE__",
      type: "__TODO_TRANSLATE__",
      locationLabel: "__TODO_TRANSLATE__",
      location: "__TODO_TRANSLATE__",
      rateLabel: "__TODO_TRANSLATE__",
      rate: "__TODO_TRANSLATE__",
      aboutHeading: "__TODO_TRANSLATE__",
      aboutBody: "__TODO_TRANSLATE__",
      responsibilitiesHeading: "__TODO_TRANSLATE__",
      responsibilities: ["__TODO_TRANSLATE__"],
      requirementsHeading: "__TODO_TRANSLATE__",
      requirements: ["__TODO_TRANSLATE__"],
      offerHeading: "__TODO_TRANSLATE__",
      offer: ["__TODO_TRANSLATE__"],
      applyHeading: "__TODO_TRANSLATE__",
      applyIntro: "__TODO_TRANSLATE__",
      compensationHeading: "__TODO_TRANSLATE__",
      compensationText: "__TODO_TRANSLATE__",
      compensationCurrencyNote: "__TODO_TRANSLATE__",
      workModelLabel: "__TODO_TRANSLATE__",
      workModelValue: "__TODO_TRANSLATE__",
      inPersonNote: "__TODO_TRANSLATE__",
      currencyEUR: "EUR (€)",
      currencyGBP: "GBP (£)",
      currencyUSD: "USD ($)",
    },
    form: {
      heading: "__TODO_TRANSLATE__",
      subheading: "__TODO_TRANSLATE__",
      required: "*",
      fullName: "__TODO_TRANSLATE__",
      email: "__TODO_TRANSLATE__",
      phone: "__TODO_TRANSLATE__",
      location: "__TODO_TRANSLATE__",
      languages: "__TODO_TRANSLATE__",
      linkedin: "__TODO_TRANSLATE__",
      experienceLabel: "__TODO_TRANSLATE__",
      experienceOptions: ["__TODO_TRANSLATE__"],
      availability: "__TODO_TRANSLATE__",
      hourlyRate: "__TODO_TRANSLATE__",
      cvUpload: "__TODO_TRANSLATE__",
      cvHelper: "__TODO_TRANSLATE__",
      message: "__TODO_TRANSLATE__",
      submit: "__TODO_TRANSLATE__",
      submitting: "__TODO_TRANSLATE__",
      successHeading: "__TODO_TRANSLATE__",
      successText: "__TODO_TRANSLATE__",
      privacy: "__TODO_TRANSLATE__",
      phFullName: "__TODO_TRANSLATE__",
      phEmail: "__TODO_TRANSLATE__",
      phPhone: "__TODO_TRANSLATE__",
      phLocation: "__TODO_TRANSLATE__",
      phLanguages: "__TODO_TRANSLATE__",
      phLinkedin: "__TODO_TRANSLATE__",
      phAvailability: "__TODO_TRANSLATE__",
      phHourlyRate: "__TODO_TRANSLATE__",
      phMessage: "__TODO_TRANSLATE__",
    },
    onboarding: {
      eyebrow: "__TODO_TRANSLATE__",
      heading: "__TODO_TRANSLATE__",
      headingItalic: "__TODO_TRANSLATE__",
      subtitle: "__TODO_TRANSLATE__",
      steps: [{ title: "__TODO_TRANSLATE__", description: "__TODO_TRANSLATE__" }],
      nextStepsHeading: "__TODO_TRANSLATE__",
      nextStepsBody: "__TODO_TRANSLATE__",
    },
    documents: {
      eyebrow: "__TODO_TRANSLATE__",
      heading: "__TODO_TRANSLATE__",
      headingItalic: "__TODO_TRANSLATE__",
      subtitle: "__TODO_TRANSLATE__",
      downloadBtn: "__TODO_TRANSLATE__",
      versionLabel: "__TODO_TRANSLATE__",
      typeLabel: "__TODO_TRANSLATE__",
    },
  },
...
const sk: typeof en = {
  ...
  workWithUs: {
    eyebrow: "Kariéra a kontraktori",
    heading: "Pracuj s",
    headingItalic: "Andy'K Group",
    subtitle: "Spolupracujeme so štruktúrovanými, samostatnými nezávislými kontraktormi — operatívnymi partnermi, ktorí preberajú plnú zodpovednosť za svoju prácu.",
    openPositionsHeading: "Aktuálne pozície",
    contractorBadge: "Nezávislý kontraktor",
    remoteBadge: "Remote",
    viewRole: "Zobraziť pozíciu",
    noOpenings: "Momentálne nie sú otvorené žiadne ďalšie pozície. Skús to neskôr.",
    role: {
      title: "Osobný asistent a podpora predaja",
      eyebrow: "Otvorená pozícia — nezávislý kontraktor",
      overviewLabel: "Prehľad pozície",
      overview: "Pozícia pre nezávislého kontraktora na diaľku, podporujúca operatívnu a obchodnú vrstvu Andy'K Group International LTD. Budeš úzko spolupracovať so zakladateľským tímom — administratívna koordinácia, výskumné úlohy a podpora predajných aktivít.",
      typeLabel: "Typ spolupráce",
      type: "Nezávislý kontraktor",
      locationLabel: "Lokalita",
      location: "Viedeň, Rakúsko",
      rateLabel: "Odmena",
      rate: "Dohodou — podľa zmluvy s kontraktorom",
      aboutHeading: "O pozícii",
      aboutBody: "Nejde o klasický pracovný pomer. Spolupracujeme s nezávislými kontraktormi, ktorí prinášajú do každej úlohy štruktúru, presnosť a samostatnosť. Budeš podporovať operatívnu a obchodnú infraštruktúru Andy'K Group — od administratívnej koordinácie po výskum a podporu predaja — v priamej spolupráci so zakladateľským tímom.",
      responsibilitiesHeading: "Náplň práce",
      responsibilities: [
        "Administratívna koordinácia: plánovanie, správa dokumentov, follow-upy",
        "Výskum: prieskum trhu, vyhľadávanie potenciálnych klientov, analýza konkurencie",
        "Podpora predaja: aktualizácia CRM, príprava oslovení, formátovanie ponúk",
        "Koordinácia klientov: onboarding komunikácia, správa dokumentácie",
        "Operatívna administratíva: podpora interných procesov, zadávanie dát, štruktúrovaný reporting",
      ],
      requirementsHeading: "Požiadavky",
      requirements: [
        "Preukázateľná skúsenosť s administratívou, výskumom alebo podporou predaja",
        "Veľmi dobrá písomná angličtina — všetka interná komunikácia prebieha v angličtine",
        "Samostatnosť, zmysel pre detail a štruktúrované myslenie",
        "Schopnosť pracovať na diaľku a asynchrónne",
        "Dostupnosť na pravidelné týždenné check-iny",
        "Znalosť CRM nástrojov, Google Workspace alebo podobných platforiem",
        "Aktívny profil na LinkedIn je nutnosťou",
      ],
      offerHeading: "Čo ponúkame",
      offer: [
        "Konkurencieschopná hodinová sadzba — dohodnutá individuálne",
        "Remote-first, async-first pracovné prostredie",
        "Priama spolupráca so zakladateľmi",
        "Štruktúrovaný onboarding proces pre kontraktorov",
        "Skúsenosti s medzinárodnými B2B a B2G klientskymi projektmi",
      ],
      applyHeading: "Prihlás sa na túto pozíciu",
      applyIntro: "Vyplň prihlasovací formulár nižšie. Každú prihlášku posudzujeme osobne a odpovieme do 5 pracovných dní.",
      compensationHeading: "Odmena",
      compensationText: "Ide o čiastočný úväzok formou freelance kontraktu. Očakávaný rozsah práce: 10–20 hodín mesačne. Mesačný rozpočet: do 400 €, v závislosti od skúseností, dostupnosti a dohodnutého rozsahu práce. Hodinová sadzba sa dohodne individuálne.",
      compensationCurrencyNote: "Prepočet meny slúži len na zobrazenie/orientáciu. Finálna zmluvná mena sa dohodne individuálne v Zmluve s kontraktorom.",
      workModelLabel: "Forma spolupráce",
      workModelValue: "Preferovaná hybridná forma — remote možné po dohode",
      inPersonNote: "Ideálny kandidát by mal byť dostupný na príležitostné osobné pracovné stretnutia vo Viedni (zvyčajne 2–3-krát mesačne), popri práci na diaľku, tam kde je to užitočné pre koordináciu a plánovanie.",
      currencyEUR: "EUR (€)",
      currencyGBP: "GBP (£)",
      currencyUSD: "USD ($)",
    },
    form: {
      heading: "Prihlasovací formulár",
      subheading: "Osobný asistent a podpora predaja — nezávislý kontraktor",
      required: "*",
      fullName: "Celé meno",
      email: "Emailová adresa",
      phone: "Telefónne číslo",
      location: "Tvoja lokalita",
      languages: "Jazyky, ktorými hovoríš",
      linkedin: "LinkedIn profil",
      experienceLabel: "Relevantná skúsenosť",
      experienceOptions: [
      ...
      hourlyRate: "Preferovaná hodinová sadzba",
      cvUpload: "Nahraj CV / životopis",
      cvHelper: "PDF, DOC alebo DOCX — max 10 MB",
      message: "Krátka správa",
      submit: "Odoslať prihlášku",
      submitting: "Odosielam…",
      successHeading: "Prihláška prijatá",
      successText: "Ďakujeme za prihlášku. Náš tím každú prihlášku osobne posúdi a odpovie do 5 pracovných dní.",
      privacy: "Odoslaním tohto formulára súhlasíš s našimi Zásadami ochrany osobných údajov. Tvoje údaje použijeme výlučne na účely náboru.",
      phFullName: "Tvoje celé meno",
      phEmail: "tvoj@email.com",
      phPhone: "+43 000 000 000",
      phLocation: "Mesto, krajina",
      phLanguages: "napr. slovenčina, angličtina, nemčina",
      phLinkedin: "linkedin.com/in/tvojprofil",
      phAvailability: "napr. 20 hod/týždeň od júla 2026",
      phHourlyRate: "napr. 20 €/hod",
      phMessage: "Povedz nám, prečo si vhodný kandidát na túto pozíciu…",
    },
    onboarding: {
      eyebrow: "Onboarding kontraktorov",
      heading: "Začíname ako",
      headingItalic: "kontraktor",
      subtitle: "Štruktúrovaný onboarding proces pre nových nezávislých kontraktorov Andy'K Group.",
      steps: [
        { title: "Prihláška odoslaná", description: "Tvoju prihlášku prijme a interne posúdi prevádzkový tím." },
        { title: "Úvodný hovor", description: "20–30 minútový videohovor na posúdenie vhodnosti, predstavenie pozície a zodpovedanie otázok." },
        { title: "Skúšobná úloha", description: "Krátka platená skúšobná úloha na overenie pracovného štýlu a kvality výstupov." },
        { title: "Zmluva a dohoda", description: "Preskúmanie a podpis zmluvy s nezávislým kontraktorom. Všetky zmluvy sú digitálne." },
        { title: "Systémový onboarding", description: "Prístupové údaje, orientácia v nástrojoch a prvý štruktúrovaný brífing s tímom." },
        { title: "Aktívna spolupráca", description: "Pridelí sa ti prvá štruktúrovaná úloha. Začínajú pravidelné týždenné check-iny." },
      ],
      nextStepsHeading: "Máš otázky?",
      nextStepsBody: "Kontaktuj prevádzkový tím na info@andykgroup.com s akýmikoľvek otázkami ohľadom onboardingu.",
    },
    documents: {
      eyebrow: "Zdroje pre kontraktorov",
      heading: "Centrum",
      headingItalic: "dokumentov",
      subtitle: "Oficiálne dokumenty pre kontraktorov — zmluvy, zásady a prevádzkové referencie.",
...
const de: typeof en = {
  ...
  workWithUs: {
    eyebrow: "Karriere & Auftragnehmer",
    heading: "Arbeite mit",
    headingItalic: "Andy'K Group",
    subtitle: "Wir arbeiten mit hochgradig strukturierten, selbstständig agierenden unabhängigen Auftragnehmern zusammen — operative Partner, die Verantwortung für ihre Arbeit übernehmen.",
    openPositionsHeading: "Offene Positionen",
    contractorBadge: "Unabhängiger Auftragnehmer",
    remoteBadge: "Remote",
    viewRole: "Position ansehen",
    noOpenings: "Derzeit keine weiteren offenen Positionen. Schau bald wieder vorbei.",
    role: {
      title: "Persönliche Assistenz & Vertriebsunterstützung",
      eyebrow: "Offene Position — Unabhängiger Auftragnehmer",
      overviewLabel: "Positionsübersicht",
      overview: "Eine Remote-Position als unabhängiger Auftragnehmer zur Unterstützung der operativen und kommerziellen Ebene von Andy'K Group International LTD. Du arbeitest eng mit dem Gründerteam zusammen — administrative Koordination, Recherche-Aufgaben und Vertriebsunterstützung.",
      typeLabel: "Vertragsart",
      type: "Unabhängiger Auftragnehmer",
      locationLabel: "Standort",
      location: "Wien, Österreich",
      rateLabel: "Vergütung",
      rate: "Verhandelbar — gemäß Auftragnehmervertrag",
      aboutHeading: "Über die Position",
      aboutBody: "Dies ist keine klassische Anstellung. Wir arbeiten mit unabhängigen Auftragnehmern zusammen, die jeder Aufgabe Struktur, Präzision und Eigeninitiative verleihen. Du unterstützt die operative und kommerzielle Infrastruktur von Andy'K Group — von administrativer Koordination bis hin zu Recherche und Vertriebsunterstützung — in direkter Zusammenarbeit mit dem Gründerteam.",
      responsibilitiesHeading: "Aufgaben",
      responsibilities: [
        "Administrative Koordination: Terminplanung, Dokumentenverwaltung, Nachverfolgung",
        "Recherche: Marktanalyse, Recherche zu potenziellen Kunden, Wettbewerbsanalyse",
        "Vertriebsunterstützung: CRM-Pflege, Vorbereitung von Outreach-Maßnahmen, Angebotsformatierung",
        "Kundenkoordination: Onboarding-Kommunikation, Dokumentenbearbeitung",
        "Operative Administration: Unterstützung interner Prozesse, Dateneingabe, strukturiertes Reporting",
      ],
      requirementsHeading: "Anforderungen",
      requirements: [
        "Nachgewiesene Erfahrung in Administration, Recherche oder Vertriebsunterstützung",
        "Sehr gutes schriftliches Englisch — die gesamte interne Kommunikation erfolgt auf Englisch",
        "Selbstständige Arbeitsweise mit hoher Detailgenauigkeit und strukturiertem Denken",
        "Erfahrung mit Remote- und asynchroner Zusammenarbeit",
        "Verfügbarkeit für strukturierte wöchentliche Check-ins",
        "Sicherer Umgang mit CRM-Tools, Google Workspace oder vergleichbaren Plattformen",
        "Aktives LinkedIn-Profil erforderlich",
      ],
      offerHeading: "Was wir bieten",
      offer: [
        "Wettbewerbsfähiger Stundensatz — individuell vereinbart",
        "Remote-first, async-first Arbeitsumfeld",
        "Direkte Zusammenarbeit mit den Gründern",
        "Strukturierter Onboarding-Prozess für Auftragnehmer",
        "Einblick in internationale B2B- und B2G-Kundenprojekte",
      ],
      applyHeading: "Für diese Position bewerben",
      applyIntro: "Fülle das untenstehende Bewerbungsformular aus. Wir prüfen jede Bewerbung persönlich und melden uns innerhalb von 5 Werktagen.",
      compensationHeading: "Vergütung",
      compensationText: "Dies ist eine freiberufliche Teilzeit-Auftragnehmer-Position. Erwarteter Arbeitsumfang: 10–20 Stunden pro Monat. Monatliches Budget: bis zu 400 €, abhängig von Erfahrung, Verfügbarkeit und vereinbartem Aufgabenumfang. Der Stundensatz wird individuell vereinbart.",
      compensationCurrencyNote: "Die Währungsauswahl dient ausschließlich der Anzeige/Umrechnung. Die endgültige Vertragswährung wird individuell im Auftragnehmervertrag vereinbart.",
      workModelLabel: "Arbeitsmodell",
      workModelValue: "Hybrid bevorzugt — Remote nach Vereinbarung möglich",
      inPersonNote: "Der ideale Kandidat sollte für gelegentliche persönliche Arbeitstreffen in Wien verfügbar sein (in der Regel 2–3 Mal pro Monat), zusätzlich zur Remote-Arbeit, wo dies für Koordination und Planung sinnvoll ist.",
      currencyEUR: "EUR (€)",
      currencyGBP: "GBP (£)",
      currencyUSD: "USD ($)",
    },
    form: {
      ...
      subheading: "Persönliche Assistenz & Vertriebsunterstützung — Unabhängiger Auftragnehmer",
      required: "*",
      ...
      linkedin: "LinkedIn-Profil",
      experienceLabel: "Relevante Erfahrung",
      experienceOptions: [
      ...
      hourlyRate: "Bevorzugter Stundensatz",
      cvUpload: "Lebenslauf hochladen",
      cvHelper: "PDF, DOC oder DOCX — max. 10 MB",
      message: "Kurze Nachricht",
      submit: "Bewerbung absenden",
      submitting: "Wird gesendet…",
      successHeading: "Bewerbung erhalten",
      successText: "Vielen Dank für deine Bewerbung. Unser Team prüft jede Bewerbung persönlich und meldet sich innerhalb von 5 Werktagen.",
      privacy: "Mit dem Absenden dieses Formulars stimmst du unserer Datenschutzrichtlinie zu. Deine Daten werden ausschließlich für Rekrutierungszwecke verwendet.",
      phFullName: "Dein vollständiger Name",
      phEmail: "deine@email.com",
      phPhone: "+43 000 000 000",
      phLocation: "Stadt, Land",
      phLanguages: "z. B. Deutsch, Englisch, Slowakisch",
      phLinkedin: "linkedin.com/in/deinprofil",
      phAvailability: "z. B. 20 Std/Woche ab Juli 2026",
      phHourlyRate: "z. B. 20 €/Std",
      phMessage: "Erzähl uns, warum du gut zu dieser Position passt…",
    },
    onboarding: {
      eyebrow: "Onboarding für Auftragnehmer",
      heading: "Erste Schritte als",
      headingItalic: "Auftragnehmer",
      subtitle: "Ein strukturierter Onboarding-Prozess für neue unabhängige Auftragnehmer von Andy'K Group.",
      steps: [
        { title: "Bewerbung eingereicht", description: "Deine Bewerbung wird empfangen und intern vom Operations-Team geprüft." },
        { title: "Vorstellungsgespräch", description: "Ein 20–30-minütiges Videogespräch zur Einschätzung der Eignung, Besprechung der Position und Beantwortung deiner Fragen." },
        { title: "Probeaufgabe", description: "Eine kurze, bezahlte Probeaufgabe zur Bewertung von Arbeitsweise und Qualität." },
        { title: "Vertrag & Vereinbarung", description: "Prüfung und Unterzeichnung des Vertrags für unabhängige Auftragnehmer. Alle Verträge sind digital." },
        { title: "Systemeinführung", description: "Zugangsdaten, Einführung in die Tools und erstes strukturiertes Briefing mit dem Team." },
        { title: "Aktive Zusammenarbeit", description: "Deine erste strukturierte Aufgabe wird zugewiesen. Wöchentliche Check-ins beginnen." },
      ],
      nextStepsHeading: "Fragen?",
      nextStepsBody: "Kontaktiere das Operations-Team unter info@andykgroup.com bei Fragen zum Onboarding.",
    },
    documents: {
      eyebrow: "Ressourcen für Auftragnehmer",
      heading: "Dokumenten-",
      headingItalic: "Zentrale",
      subtitle: "Offizielle Dokumente für Auftragnehmer — Verträge, Richtlinien und betriebliche Referenzen.",
